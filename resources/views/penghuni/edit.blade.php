            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('penghuni.update', $penghuni) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="nikInput" type="text" inputmode="numeric" name="nik" class="form-control @error('nik') is-invalid @enderror" value="{{ old('nik', $penghuni->nik) }}" required>
                        @error('nik') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        <div class="invalid-feedback d-none" id="nikFeedback">Teks yang dimasukkan harus angka.</div>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">No HP</label>
                        <input id="noHpInput" type="text" inputmode="numeric" name="no_hp" class="form-control @error('no_hp') is-invalid @enderror" value="{{ old('no_hp', $penghuni->no_hp) }}" required>
